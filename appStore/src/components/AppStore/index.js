...
import AppIconItem from '../AppItem/index'
...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchData = appsList.filter(
      each =>
      ...
      <div className="main">
        <div className="main-container">
          ...
          <ul className="tab-container">
            {tabsList.map(each => (
              <TabItem
                activeTabId={activeTab === each.tabId}
                tabItemDetails={each}
          ...
          <ul className="appItemContainer">
            {searchData.map(each => (
              <AppIconItem appItemDetails={each} key={each.appId} />
            ))}
          </ul>
        </div>
      </div>
